...
class Like {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".like-box").on("click", this.onClickDispatcher.bind(this));
  }
  onClickDispatcher(e) {
...
class MyNotes {
  ...
  createNote(e) {
    var thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parent(".create-note");
    var ourNewPost = {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      error: response => {
        if (response.responseText == "You have reached you rnote limit.") {
  ...
  makeNoteEditable(thisNote) {
    thisNote.find(".edit-note").html("<i class=\"fa fa-times\" aria-hidden=\"hidden\"></i> Cancel");
    thisNote.find(".note-title-field, .note-body-field").removeAttr("readonly").addClass("note-active-field");
    thisNote.find(".update-note").addClass("update-note--visible");
    thisNote.data("state", "editable");
  }
  makeNoteReadOnly(thisNote) {
    thisNote.find(".edit-note").html("<i class=\"fa fa-pencil\" aria-hidden=\"hidden\"></i> Edit");
